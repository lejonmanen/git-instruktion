...
![Skapa nytt repo](../img/git/gh-create-repo-0.png)
![Skapa nytt repo](../img/git/gh-create-repo-1.png)

### Koppla ihop dina båda repon
![Skapa nytt repo](../img/git/gh-create-repo-2.png)
...
![Commit history](../img/git/gh-commit-history.png)
...
![Ändra fil 1](../img/git/gh-edit-file.png)
...
![Ändra fil 2](../img/git/gh-edit-file-2.png)
...
![Pull Request Button](../img/git/github-pr-button.jpg)
1. Det går också att skapa en pull request via meny-alternativet "Pull requests"
![Pull Request Page](../img/git/gh-pull-request-create.jpg)
